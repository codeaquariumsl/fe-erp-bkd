...
// Get sales items for mobile with active items, and stock details
exports.getSalesItemsByCustomerMobile = async (req, res) => {
    try {
        ...
        // Fetch all active items directly
        ...
        for (const item of items) {
            ...
            const totalAvailableQty = stocks.reduce((sum, stock) => sum + Number(stock.availableQty || 0), 0);
